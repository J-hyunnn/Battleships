...
function playerHardAI(){
    ...
    console.log ("Hard AI is playing (playerHardAI)")

    checkIfThereIsBoat = playermap;
    checkIfThereIsBoat.indexOf ("B");
    console.log (checkIfThereIsBoat);
...
function chooseAI(){
    if (start === true){
        console.log ("Du spelar mot Hard AI");
        playerHardAI();
        //$("#vilkenAI").text("Duspelar mot Har AI nu.")
    } else {
        console.log ("Du spelar mot Easy AI");
        playerEasyAI();
    }
